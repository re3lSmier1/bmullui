...
function PhotoSync(){
  ...
  useProductStore().BulkUploadPhotos(fd)
}
...
function UploadBulk(){
  ...
  productStore.BulkUploadProducts().then(response => {
    ...
    loading.value = false;
    alert("Bulk upload was not successful")
  })
}
</script>
...
<!--        <v-btn color="primary" variant="elevated">New User</v-btn>-->
    ...
    <div class="pa-5">
      ...
      <v-file-input  color="primary" :loading="loading" :disabled="loading"  ref="file"></v-file-input>
